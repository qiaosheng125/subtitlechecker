...
export default function SubtitleCheckerApp() {
  ...
  function onFileChange(event: ChangeEvent<HTMLInputElement>) {
    ...
    if (file.size > MAX_FILE_BYTES) {
      setFileError("This file is too large. Please use an SRT file under 1 MB.");
      event.target.value = "";
      return;
    }
    ...
    reader.onload = () => {
      ...
      if (nextText.length > MAX_TEXT_CHARS) {
        setText(nextText.slice(0, MAX_TEXT_CHARS));
        setFileError("Only the first 500,000 characters were loaded for this browser check.");
        return;
      }
      setText(nextText);
    };
          ...
          <div className="inputPanel">
            ...
            <textarea
              ...
              onChange={(event) => {
                ...
                if (nextText.length > MAX_TEXT_CHARS) {
                  setText(nextText.slice(0, MAX_TEXT_CHARS));
                  setFileError("Only the first 500,000 characters can be checked at once.");
                  return;
                }
                setFileError("");
                setText(nextText);
